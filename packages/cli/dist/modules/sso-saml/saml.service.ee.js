...
let SamlService = class SamlService {
    ...
    constructor(logger, urlService, validator, userRepository, settingsRepository, instanceSettings, provisioningService, cipher) {
        this.logger = logger;
    ...
    validateSigningKeyConfiguration(prefs) {
