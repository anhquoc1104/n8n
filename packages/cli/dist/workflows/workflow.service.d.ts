...
import { SharedWorkflow, ExecutionRepository, FolderRepository, WorkflowTagMappingRepository, SharedWorkflowRepository, WorkflowRepository, WorkflowPublishedVersionRepository, WorkflowPublishHistoryRepository, ProjectRepository } from '@n8n/db';
...
export declare class WorkflowService {
    ...
    getMany(user: User, options?: ListQuery.Options, includeScopes?: boolean, includeFolders?: boolean, onlySharedWithMe?: boolean, requiredScopes?: Scope[]): Promise<{
        workflows: ((Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "createdAt" | "updatedAt" | "name" | "description" | "active" | "tags" | "versionId" | "activeVersionId">>) | (import("@n8n/db").Folder & {
