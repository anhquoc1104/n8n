...
import { WorkflowEntity, User } from '../entities';
...
export declare class WorkflowRepository extends Repository<WorkflowEntity> {
    ...
    getWorkflowsAndFoldersUnion(workflowIds: string[], options?: ListQuery.Options, accessibleProjectIds?: string[]): Promise<{
        id: string;
        name: string;
        resource: ResourceType;
        createdAt: Date;
    ...
    getWorkflowsAndFoldersCount(workflowIds: string[], options?: ListQuery.Options, accessibleProjectIds?: string[]): Promise<number>;
    getWorkflowsAndFoldersWithCount(workflowIds: string[], options?: ListQuery.Options, accessibleProjectIds?: string[]): Promise<readonly [WorkflowFolderUnionFull[], number]>;
    getWorkflowsAndFoldersWithCountWithSharingSubquery(user: User, sharingOptions: {
        scopes?: Scope[];
        projectRoles?: string[];
    ...
    }, options?: ListQuery.Options): Promise<readonly [WorkflowFolderUnionFull[], number]>;
    private getWorkflowsAndFoldersUnionWithSharingSubquery;
    private getWorkflowsAndFoldersCountWithSharingSubquery;
    ...
    getMany(workflowIds: string[], options?: ListQuery.Options): Promise<(Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "name" | "createdAt" | "updatedAt" | "description" | "active" | "tags" | "versionId" | "activeVersionId">>)[]>;
    getManyAndCount(sharedWorkflowIds: string[], options?: ListQuery.Options): Promise<{
        workflows: (Pick<WorkflowEntity, "id"> & Partial<Pick<WorkflowEntity, "name" | "createdAt" | "updatedAt" | "description" | "active" | "tags" | "versionId" | "activeVersionId">>)[] | ListQueryDb.Workflow.WithSharing[];
        count: number;
    }>;
