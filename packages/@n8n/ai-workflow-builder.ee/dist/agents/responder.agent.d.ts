...
export declare function createResponderAgent(config: ResponderAgentConfig): import("langchain").ReactAgent<import("langchain").AgentTypeConfig<import("langchain").ResponseFormatUndefined, undefined, z.ZodObject<{
    ...
    workflowJSON?: any;
    discoveryContext?: any;
}, readonly (import("@langchain/core/tools").ClientTool | import("@langchain/core/tools").ServerTool)[]>], readonly (import("@langchain/core/tools").ClientTool | import("@langchain/core/tools").ServerTool | import("langchain").DynamicStructuredTool<z.ZodObject<{
    issue: z.ZodString;
