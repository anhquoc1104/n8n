    ...
    async execute() {
        ...
        try {
            ...
            if (mode === 'queue') {
                ...
                ({ channel, channelModel } = await GenericFunctions_1.rabbitmqConnectQueue.call(this, queue, options));
                ...
                const options = this.getNodeParameter('options', 0, {});
                ({ channel, channelModel } = await GenericFunctions_1.rabbitmqConnectExchange.call(this, exchange, options));
                const sendInputData = this.getNodeParameter('sendInputData', 0);
                let message;
