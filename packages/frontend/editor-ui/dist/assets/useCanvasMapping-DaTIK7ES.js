...
import { _ as onKeyDown, bt as useI18n, ct as useThrottleFn, dt as watchThrottled, ut as watchOnce, y as onKeyUp } from "./_MapCache-B2nOWWtr.js";
...
import { An as useGetPointerPosition, Br as CanvasConnectionMode, Ca as isPresent, Cn as clamp, Dn as getRectOfNodes, Dt as injectWorkflowState, En as getConnectedEdges, Fn as trackTemplatesClick, Hr as CanvasNodeRenderType, Ir as isValidNodeConnectionType, Jt as useTemplatesStore, Kn as useFocusedNodesStore, Mn as wheelDelta, Mt as nodeViewEventBus, Nn as TemplateClickSource, Ns as useSettingsStore, On as getSmoothStepPath, Pn as isExtraTemplateLinksExperimentEnabled, Qt as DEFAULT_NODE_SIZE, Rn as useStyles, Sn as _sfc_main$f, Tn as getBoundsofRects, Vr as CanvasNodeDirtiness, Xt as CONFIGURATION_NODE_RADIUS, Yi as getTriggerNodeServiceName, _n as Position, _r as useNDVStore, aa as createWorkflowDocumentId, at as useCredentialsStore, bn as _sfc_main$3, ca as useWorkflowDocumentStore, ci as useSourceControlStore, cn as getMousePosition, cr as environments_store_default, en as GRID_SIZE, gl as sanitizeHtml, gn as PanelPosition, hl as isOutsideSelected, hn as NodeId, jn as useVueFlow, kn as isMacOs, mn as MarkerType, nn as calculateNodeSize, pn as updateViewportToContainNodes, r as useUIStore, s as useWorkflowsStore, sa as injectWorkflowDocumentStore, t as useUsersStore, ur as useNodeHelpers, vn as _sfc_main$5, w as useNodeTypesStore, wn as getBezierPath, xn as _sfc_main$d, yn as _sfc_main$1 } from "./users.store-CMoFfg_u.js";
import { M as TitledList_default } from "./ParameterInputList-DjBBqcPi.js";
import { Aa as isNodeWithWorkflowSelector, Ac as CanvasNodeKey, Bo as SEND_AND_WAIT_OPERATION, Cr as WAIT_NODE_TYPE, Gt as CHAT_TRIGGER_NODE_TYPE, Ho as WAIT_INDEFINITELY, I as CUSTOM_API_CALL_KEY, Ko as require_isEqual, Mc as ExpressionLocalResolveContextSymbol, Nt as AGENT_NODE_TYPE, Oa as isExecutable, Oc as CanvasKey, Pt as AGENT_TOOL_NODE_TYPE, Qa as isCommunityPackageName, Qn as PRODUCTION_ONLY_TRIGGER_NODE_TYPES, Ta as getSubworkflowId, Tt as NODE_CREATOR_OPEN_SOURCES, Uo as WEBHOOK_NODE_TYPE, Wn as NOT_DUPLICATABLE_NODE_TYPES, as as getResourcePermissions, da as mapConnectionsByDestination, dr as SIMULATE_TRIGGER_NODE_TYPE, ds as VIEWS, fl as CANVAS_EXECUTION_DATA_THROTTLE_DURATION, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, hn as FORM_NODE_TYPE, ka as isHitlToolType, kc as CanvasNodeHandleKey, ur as SIMULATE_NODE_TYPE, va as getNodeInputs, ya as getNodeOutputs } from "./constants-5-othRBB.js";
...
import { t as usePinnedData } from "./usePinnedData-CHIf8ABu.js";
import { t as getNodeIconSource } from "./nodeIcon-D1Y-PdrL.js";
import { c as parseCanvasConnectionHandleString, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections, r as insertSpacersBetweenEndpoints, s as mapLegacyEndpointsToCanvasConnectionPort, t as checkOverlap } from "./canvas.utils-BASL3jxq.js";
import { n as useNodeCreatorStore } from "./canvas.eventBus-DIfL9Afg.js";
...
import { r as useNodeDirtiness, t as useRunWorkflow } from "./useRunWorkflow-CyLFpzD5.js";
import { n as injectStrict } from "./useInjectWorkflowId-Q05lQ6cx.js";
import { t as useCollaborationStore } from "./collaboration.store-CRng_rS2.js";
import { t as NodeSettings_default } from "./NodeSettings-DkUgCdA_.js";
...
import { t as NODE_CREATOR_SHORTCUT_COACHMARK_KEY } from "./useNodeCreatorShortcutCoachmark-CX4Azjkd.js";
