...
import { M as useLocalStorage, S as useClipboard, bt as useI18n } from "./_MapCache-B2nOWWtr.js";
import { Ni as require_markdown_it_link_attributes, _t as useRouter, gt as useRoute } from "./src-Brfg9f4I.js";
import { t as __plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-DltO58Gh.js";
import { $r as ReplaceNodeParametersCommand, $t as DEFAULT_VIEWPORT_BOUNDARIES, Br as CanvasConnectionMode, Ca as isPresent, Dt as injectWorkflowState, Et as useWorkflowHelpers, Gr as AddNodeCommand, Hr as CanvasNodeRenderType, Ir as isValidNodeConnectionType, Jt as useTemplatesStore, Ln as useToast, Ns as useSettingsStore, Oa as tryToParseNumber, Ot as useWorkflowState, Qr as RenameNodeCommand, Qt as DEFAULT_NODE_SIZE, Ur as useHistoryStore, Ut as useFocusPanelStore, Wr as AddConnectionCommand, Xr as RemoveConnectionCommand, Yr as MoveNodeCommand, Yt as CONFIGURABLE_NODE_SIZE, Zr as RemoveNodeCommand, Zt as CONFIGURATION_NODE_SIZE, _r as useNDVStore, aa as createWorkflowDocumentId, at as useCredentialsStore, b as getExecutionErrorToastConfiguration, ca as useWorkflowDocumentStore, d as isChatNode, da as pinDataToExecutionData, dn as getNodesGroupSize, dr as useCanvasStore, en as GRID_SIZE, gr as usePostHog, in as generateOffsets, ln as getNewNodePosition, lt as useDataSchema, nr as useTagsStore, pr as useTelemetry, r as useUIStore, rn as doRectsOverlap, s as useWorkflowsStore, si as useProjectsStore, tn as PUSH_NODES_OFFSET, ur as useNodeHelpers, w as useNodeTypesStore, z as removePreviewToken, zn as useExternalHooks } from "./users.store-CMoFfg_u.js";
import { Hi as require_cloneDeep, La as resolveNodeWebhookId, Pn as MCP_TRIGGER_NODE_TYPE, Qa as isCommunityPackageName, Sr as UPDATE_WEBHOOK_ID_NODE_TYPES, Ta as getSubworkflowId, Uc as CANVAS_ZOOMED_VIEW_EXPERIMENT, Wo as v4_default, Xi as require__baseUniq, Za as deepCopy, _a as getConnectionTypes, ba as getNodeParameters, dc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL, dl as EnterpriseEditionFeature, ds as VIEWS, fc as LOCAL_STORAGE_LOGS_PANEL_DETAILS_PANEL_SUB_NODE, gn as FORM_TRIGGER_NODE_TYPE, go as NodeConnectionTypes, gr as STICKY_NODE_TYPE, ka as isHitlToolType, ma as generateNodesGraph, mc as LOCAL_STORAGE_LOGS_SYNC_SELECTION, pc as LOCAL_STORAGE_LOGS_PANEL_OPEN, tl as NDV_IN_FOCUS_PANEL_EXPERIMENT, va as getNodeInputs, wr as WEBHOOK_NODE_TYPE, ya as getNodeOutputs } from "./constants-5-othRBB.js";
import { j as defineStore, r as useRootStore } from "./_baseOrderBy-3RLTGCZ5.js";
import { t as useExecutionsStore } from "./executions.store-CHPB7Qt8.js";
import { t as usePinnedData } from "./usePinnedData-CHIf8ABu.js";
import { a as mapLegacyConnectionToCanvasConnection, c as parseCanvasConnectionHandleString, i as mapCanvasConnectionToLegacyConnection, n as createCanvasConnectionHandleString, o as mapLegacyConnectionsToCanvasConnections } from "./canvas.utils-BASL3jxq.js";
...
import { t as VueMarkdown_default } from "./VueMarkdown-BzxZ09VK.js";
import { t as useSetupPanelStore } from "./setupPanel.store-CS0dmS37.js";
import { t as clearAllNodeResourceLocatorValues } from "./templateTransforms-CS1pHcIG.js";
