...
const updateWorkflowHistoryVersion = async (context, workflowId, versionId, data) => {
	await require_utils.patch(context.baseUrl, `/workflow-history/workflow/${workflowId}/versions/${versionId}`, data);
};
...
Object.defineProperty(exports, 'updateWorkflowHistoryVersion', {
  enumerable: true,
  get: function () {
    return updateWorkflowHistoryVersion;
  }
});
