...
import { LoginRequestDto, PasswordUpdateRequestDto, Role, SettingsUpdateRequestDto, User, UserSelfSettingsUpdateRequestDto, UserUpdateRequestDto, UsersList, UsersListFilterDto } from "@n8n/api-types";
...
declare function updateCurrentUserSettings(context: IRestApiContext, settings: UserSelfSettingsUpdateRequestDto): Promise<IUserSettings>;
