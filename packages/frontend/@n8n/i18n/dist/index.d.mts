...
declare const i18nInstance: vue_i18n0.I18n<{
  en: {
    _reusableBaseText: {
      cancel: string;
      codeNodeEditor: {
    ...
    "aiAssistant.builder.existingWorkflow.emptyState.title": string;
    "aiAssistant.builder.existingWorkflow.emptyState.body": string;
    "aiAssistant.builder.planMode.selector.build": string;
    "aiAssistant.builder.planMode.selector.build.description": string;
    "aiAssistant.builder.planMode.selector.plan": string;
    "aiAssistant.builder.planMode.selector.plan.description": string;
    "aiAssistant.builder.planMode.questions.title": string;
    "aiAssistant.builder.planMode.questions.customPlaceholder": string;
    ...
    "aiAssistant.builder.planMode.questions.somethingElse": string;
    "aiAssistant.builder.planMode.questions.clarifyPlaceholder": string;
    "aiAssistant.builder.planMode.questions.paginationOf": string;
    ...
    "aiAssistant.builder.planMode.plan.notesLabel": string;
    "aiAssistant.builder.planMode.plan.feedbackLabel": string;
    "aiAssistant.builder.planMode.plan.feedbackPlaceholder": string;
    "aiAssistant.builder.planMode.actions.submitAnswers": string;
    "aiAssistant.builder.planMode.actions.implement": string;
    "aiAssistant.builder.planMode.actions.modify": string;
    "aiAssistant.builder.planMode.actions.modifyWithFeedback": string;
    ...
    "aiAssistant.builder.executeMessage.wizardSetupSuccess": string;
    "aiAssistant.builder.setupWizard.continue": string;
    "aiAssistant.builder.setupWizard.complete": string;
    "aiAssistant.builder.setupWizard.checkingCredentials": string;
    "aiAssistant.builder.setupWizard.configureParameters": string;
    ...
    "aiAssistant.builder.upgradeWhileStreaming.cancelButtonText": string;
    ...
    "chatHub.models.selector.personalProject": string;
    "chatHub.models.selector.noMatch": string;
    "chatHub.models.selector.moreModels": string;
    ...
    "collectionParameter.addItem": string;
    "collectionParameter.deleteItem": string;
    "collectionParameter.dragItem": string;
    "collectionParameter.noProperties": string;
    "collectionParameter.allOptionsAdded": string;
    ...
    "credentialEdit.credentialSharing.info.personalSpaceRestricted": string;
    ...
    "executionDetails.versionAutosave": string;
    ...
    "executionsFilter.version": string;
    "executionsFilter.version.all": string;
    "executionsFilter.version.select": string;
    "executionsFilter.version.hint": string;
    "executionsFilter.version.noVersions": string;
    "executionsFilter.version.label": string;
    ...
    "fixedCollectionParameter.addItem": string;
    "fixedCollectionParameter.addParameter": string;
    "fixedCollectionParameter.allOptionsAdded": string;
    ...
    "fixedCollectionParameter.deleteParameter": string;
    ...
    "mcp.productionChecklist.title": string;
    ...
    "parameterInput.iconPicker.tooltip": string;
    "parameterInput.selectIcon": string;
    ...
    "pushConnection.nodeNotExecuted": string;
    "pushConnection.nodeNotExecuted.message": string;
    ...
    "settings.chatHub.providers.updated.error": string;
    "settings.chatHub.providers.table.provider": string;
    "settings.chatHub.providers.table.models": string;
    "settings.chatHub.providers.table.createdAt": string;
    "settings.chatHub.providers.table.updatedAt": string;
    "settings.chatHub.providers.table.action.editProvider": string;
    "settings.chatHub.providers.table.action.editProvider.disabled": string;
    "settings.chatHub.providers.table.title": string;
    "settings.chatHub.providers.table.refresh.tooltip": string;
    "settings.chatHub.providers.table.addProvider.button": string;
    "settings.chatHub.providers.table.empty.title": string;
    "settings.chatHub.providers.table.empty.description": string;
    "settings.chatHub.providers.modal.edit.title": string;
    "settings.chatHub.providers.modal.edit.cancel": string;
    "settings.chatHub.providers.modal.edit.confirm": string;
    "settings.chatHub.providers.modal.edit.enabled.label": string;
    "settings.chatHub.providers.modal.edit.enabled.tooltip": string;
    "settings.chatHub.providers.modal.edit.credential.label": string;
    "settings.chatHub.providers.modal.edit.credential.clearButton": string;
    "settings.chatHub.providers.modal.edit.limitModels.label": string;
    "settings.chatHub.providers.modal.edit.limitModels.tooltip": string;
    "settings.chatHub.providers.modal.edit.allowedModels.label": string;
    "settings.chatHub.providers.modal.edit.errorFetchingModels": string;
    "settings.chatHub.providers.modal.edit.models.placeholder": string;
    "settings.chatHub.providers.modal.edit.models.create": string;
    "settings.chatHub.providers.modal.edit.responsesApi.label": string;
    "settings.chatHub.providers.modal.edit.responsesApi.description": string;
    "settings.chatHub.providers.modal.edit.contextWindowLength.label": string;
    "settings.chatHub.providers.modal.edit.contextWindowLength.description": string;
    "settings.chatHub.providers.table.models.disabled": string;
    ...
    "settings.users.actions.generateInviteLink": string;
    ...
    "settings.users.inviteLinkError": string;
    ...
    "settings.provisioningConfirmDialog.enable.title": string;
    "settings.provisioningConfirmDialog.disable.title": string;
    "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne": string;
    "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partOne.withProjectRoles": string;
    "settings.provisioningConfirmDialog.breakingChangeDescription.firstSentence.partTwo": string;
    "settings.provisioningConfirmDialog.breakingChangeDescription.secondLine": string;
    "settings.provisioningConfirmDialog.disable.description": string;
    "settings.provisioningConfirmDialog.enable.checkbox": string;
    "settings.provisioningConfirmDialog.disable.checkbox": string;
    "settings.provisioningConfirmDialog.link.docs": string;
    "settings.provisioningConfirmDialog.button.enable.confirm": string;
    "settings.provisioningConfirmDialog.button.disable.confirm": string;
    ...
    "settings.sourceControl.pull.success.description": string;
    ...
    "settings.sourceControl.modals.pull.dataTablesWarning": string;
    ...
    "settings.migrationReport.detail.table.status": string;
    "settings.migrationReport.detail.table.active": string;
    "settings.migrationReport.detail.table.deactivated": string;
    "settings.migrationReport.detail.table.nodesAffected": string;
    ...
    "credentialResolverEdit.clearCredentials.label": string;
    "credentialResolverEdit.clearCredentials.placeholder": string;
    "credentialResolverEdit.clearCredentials.yes": string;
    "credentialResolverEdit.clearCredentials.no": string;
    "credentialResolverEdit.clearCredentials.error.required": string;
    "credentialResolverEdit.clearCredentials.warning": string;
    ...
    "workflowHistory.item.actions.name": string;
    "workflowHistory.item.unsaved.title": string;
    "workflowHistory.item.latest": string;
    "workflowHistory.item.active": string;
    "workflowHistory.item.publishedBy": string;
    "workflowHistory.item.currentChanges": string;
    "workflowHistory.limitDay": string;
    "workflowHistory.limitDays": string;
    "workflowHistory.limitHour": string;
    "workflowHistory.limitHours": string;
    ...
    "workflowHistory.action.nameVersion.success.title": string;
    "workflowHistory.action.nameVersion.error.title": string;
    "workflowHistory.nameVersionModal.title": string;
    "workflowHistory.nameVersionModal.confirmButton": string;
    ...
    "workflows.dependencies.tooltip": string;
    "workflows.dependencies.modal.title": string;
    "workflows.dependencies.modal.search": string;
    "workflows.dependencies.type.credentials": string;
    "workflows.dependencies.type.dataTables": string;
    ...
    "workflows.shareModal.info.personalSpaceRestricted": string;
    ...
    "dataTable.add.fromScratch": string;
    "dataTable.add.importCsv": string;
    ...
    "dataTable.upload.uploading": string;
    "dataTable.upload.selectFile": string;
    "dataTable.upload.dropOrClick": string;
    "dataTable.upload.csvOnly": string;
    "dataTable.upload.hasHeaders": string;
    "dataTable.upload.uploadButton": string;
    "dataTable.upload.success": string;
    "dataTable.upload.error": string;
    "dataTable.import.columnsFound": string;
    "dataTable.import.columnName": string;
    "dataTable.import.columnsDescription": string;
    "dataTable.import.columnType": string;
    ...
    "dataTable.importCsv": string;
    "dataTable.importCsv.title": string;
    "dataTable.importCsv.description": string;
    "dataTable.importCsv.columnMismatch": string;
    "dataTable.importCsv.unrecognizedColumnsOnly": string;
    "dataTable.importCsv.missingColumnsOnly": string;
    "dataTable.importCsv.noMatchingColumns": string;
    "dataTable.importCsv.readyToImport": string;
    "dataTable.importCsv.success": string;
    "dataTable.importCsv.error": string;
    "dataTable.importCsv.importButton": string;
    ...
    "settings.security.personalSpace.publishing.success.disabled": string;
    "settings.security.personalSpace.publishing.error": string;
    "settings.security.personalSpace.publishing.confirmMessage.disable.headline": string;
    "settings.security.personalSpace.publishing.confirmMessage.disable.message": string;
    "settings.security.personalSpace.publishing.existingCount.label": string;
    "settings.security.personalSpace.publishing.existingCount.value": string;
    "settings.security.personalSpace.sharing.title": string;
    "settings.security.personalSpace.sharing.description": string;
    "settings.security.personalSpace.sharing.success.enabled": string;
    "settings.security.personalSpace.sharing.success.disabled": string;
    "settings.security.personalSpace.sharing.error": string;
    "settings.security.personalSpace.sharing.confirmMessage.disable.headline": string;
    ...
    "settings.sso.settings.save.confirmTestConnection.title": string;
    "settings.sso.settings.save.confirmTestConnection.message": string;
    "settings.sso.settings.save.confirmTestConnection.confirm": string;
    ...
    "settings.sso.confirmMessage.beforeSaveForm.headline": string;
    "settings.sso.confirmMessage.beforeSaveForm.message": string;
    ...
    "projects.settings.externalSecrets.emptyState.projectAdmin.description": string;
    ...
    "projects.sharing.moreResults": string;
    ...
    "projects.badge.global": string;
    "projects.badge.tooltip.global": string;
    ...
    "insights.banner.queueMode.warning": string;
    "insights.banner.queueMode.warning.link.text": string;
    "insights.banner.queueMode.warning.link.url": string;
...
declare class I18nClass {
  ...
  nodeText(activeNodeType?: string | null): {
    ...
    optionsOptionDisplayName(parameter: INodeProperties, {
      value: optionName,
      name: displayName
    }: INodePropertyOptions, path: string): string;
    optionsOptionDescription(parameter: INodeProperties, {
      value: optionName,
      description
    }: INodePropertyOptions, path: string): string;
    collectionOptionDisplayName(parameter: INodeProperties, {
      name: optionName,
      displayName
    }: INodePropertyCollection, path: string): string;
