...
//#endregion
//#region src/index.ts
const i18nInstance = (0, vue_i18n.createI18n)({
	legacy: false,
	locale: "en",
	fallbackLocale: "en",
	...
	nodeText(activeNodeType) {
		...
		return {
			inputLabelDisplayName(parameter, path) {
				const middleKey = require_utils.deriveMiddleKey(path, parameter);
				return context.dynamicRender({
			...
			placeholder(parameter, path) {
				...
				if (require_utils.isNestedInCollectionLike(path)) middleKey = require_utils.insertOptionsAndValues(require_utils.normalize(path).split(".")).join(".");
				return context.dynamicRender({
...
function loadLanguage(locale, messages) {
	if (loadedLanguages.includes(locale)) return setLanguage(locale);
...
exports.i18nVersion = i18nVersion;
exports.loadLanguage = loadLanguage;
exports.setLanguage = setLanguage;
exports.updateLocaleMessages = updateLocaleMessages;
