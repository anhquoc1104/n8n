...
export declare abstract class NodeExecutionContext implements Omit<FunctionsBase, 'getCredentials'> {
    ...
    getExecutionContext(): {
        ...
        source: "cli" | "error" | "integrated" | "internal" | "manual" | "retry" | "trigger" | "webhook" | "evaluation" | "chat";
        triggerNode?: {
            name: string;
            type: string;
        } | undefined;
    ...
    getMode(): "cli" | "error" | "integrated" | "internal" | "manual" | "retry" | "trigger" | "webhook" | "evaluation" | "chat";
